...
export const REGISTER_SET_USEPROFILE = 'REGISTER_SET_USERPROFILE';
export const REGISTER_SET_REST = 'REGISTER_SET_REST';
export const REGISTER_SET_PATIENT = 'REGISTER_SET_PATIENT';
export const REGISTER_SET_STAFF = 'REGISTER_SET_STAFF';
...
// Appointment reducer types
export const FETCH_AVAILABLE_DOCTORS_START = 'FETCH_AVAILABLE_DOCTORS_START';
export const FETCH_AVAILABLE_DOCTORS_SUCCESS = 'FETCH_AVAILABLE_DOCTORS_SUCCESS';
export const FETCH_AVAILABLE_DOCTORS_FAIL = 'FETCH_AVAILABLE_DOCTORS_FAIL';

export const FETCH_SSN = 'FETCH_SSN';
export const FETCH_SSN_FAIL = 'FETCH_SSN_FAIL';
